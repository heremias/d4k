...
/* @boom/nav/nav.twig */
class __TwigTemplate_dcd35b3f3fb237befabc90d59f4078623e0d91dc469d663d27d972ff40ffad17 extends \Twig\Template
{
    private $source;
    private $macros = [];
          ...
          ";
            ...
            ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 48)) {
                    // line 49
                    echo "              ";
                    $this->loadTemplate("@boom/dropdown/dropdown-menu.twig", "@boom/nav/nav.twig", 49)->display(twig_array_merge($context, ["items" => twig_get_attribute($this->env, $this->source,                     // line 50
$context["item"], "below", [], "any", false, false, true, 50)]));
    ...
    {
        return new Source("", "@boom/nav/nav.twig", "/var/www/html/web/themes/custom/boom/src/components/nav/nav.twig");
    }
