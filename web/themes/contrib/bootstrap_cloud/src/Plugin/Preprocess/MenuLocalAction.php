...
use Drupal\bootstrap\Plugin\Preprocess\MenuLocalAction as BootstrapMenuLocalAction;
 ...
 */
class MenuLocalAction extends BootstrapMenuLocalAction {
  ...
  public function preprocessElement(Element $element, Variables $variables) {
    ...
    if (isset($link['url'])) {
      ...
      // Changing from btn-xs to btn-sm.
