...
/**
 * Class describing service for deleting log group from AWS cloudwatch logs.
 */
class DeleteLogGroup implements GetClientInterface {
   ...
   */
  public function delete(CloudWatchLogsClient $client, string $logGroupName) {
    ...
    try {
      $clientResponse = $client->deleteLogGroup($parameters);
    }
