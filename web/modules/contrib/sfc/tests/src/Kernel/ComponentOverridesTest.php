...
class ComponentOverridesTest extends KernelTestBase {
  ...
  public function testOverrides() {
    ...
    $this->assertStringContainsString('Hello <span>article</span>', (string) $renderer->renderPlain($build));

    $build = $builder->view($page);
    $this->assertStringNotContainsString('Hello <span>page</span>', (string) $renderer->renderPlain($build));
  }
